 ...
 * @endcode
 */
$settings['hash_salt'] = 'nt2Hre2rPjLUO39p50gtscIbbpHIvo1oJobnMdXIG6eHGoSla6zPZVq';
...
if ($is_local_env) {
  ...
  if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_d8contrib_dd.inc')) {
    require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_d8contrib_dd.inc';
  }
