...
@api
  ...
  Manager.
    ...
    And I press "op"
    And I visit "admin/config/development/configuration/report/diff/node_type/article"
...
@api
  ...
  should see the change in the UI.
    Given I am logged in as a user with the "Administrator" role
    And I visit "admin/config/development/configuration/report/revert/node_type/article"
    And I press "op"
